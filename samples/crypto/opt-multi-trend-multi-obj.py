...
def runstrategy(trial):
    ...
    fdm_scale = trial.suggest_float('fdm_scale', 1.00, 1.13, step=0.01)
    ...
    ewmac1_forcast_scalar = trial.suggest_float('ewmac1_forcast_scalar', 2.10, 6.10, step=0.2)
    ewmac2_forcast_scalar = trial.suggest_float('ewmac2_forcast_scalar', 2.10, 6.10, step=0.2)
    cap_max = trial.suggest_int('cap_max', 10, 20, step=1)
    cap_min = trial.suggest_int('cap_min', -20, -1, step=1)
    ...
    return value, sqn.sqn, drawdown.max.drawdown
